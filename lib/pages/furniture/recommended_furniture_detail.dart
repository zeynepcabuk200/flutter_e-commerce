...
class RecommendedFurnitureDetail extends StatelessWidget {
  final int pageId;
  final String page;
  const RecommendedFurnitureDetail({Key? key,required this.pageId,required this.page}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        SliverAppBar(
          ...
          pinned: true,
          backgroundColor: AppColors.yellowColor,//kaydırınca üst kısmın rengi
          expandedHeight: 300,
